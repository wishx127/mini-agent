# Spec: File Operation Types (Delta)

## Overview

扩展现有文件操作类型定义，新增写入、删除、移动操作相关的错误码。
...
No changes required - existing `ToolError` class supports all error codes.
